  ...
  units:[{
    ...
    lessons:[
      { id:'u1-1', title:'Lesson 1.1 · A Question of Sport', periods:4,
        ...
        teacherScreens:[
          {slide:1,title:'Unit 1.1 · A Question of Sport',body:['Lecturer: Dr. Nguyen Thi Kim Luyen','Vietnam Military Medical University · Faculty of Foreign Languages'],visualNote:'Trang mở đầu dùng cho trình chiếu trên lớp.'},
          {slide:2,title:'Materials',body:['Objective PET Book A2–B1','Unit 1.1: A Question of Sport'],visualNote:'Học liệu gốc được liên kết từ kho học liệu có kiểm soát, không nhúng bản scan vào repo public.'},
          {slide:3,title:'Aims of the Lesson',body:['Knowledge','Skills','Attitudes'],visualNote:'Màn hình định hướng ba nhóm mục tiêu trước khi vào bài.'},
          {slide:4,title:'Aims · Knowledge',body:['Identify and use vocabulary related to sports and sports equipment.','Classify and correctly use play / do / go with different sports.','Use frequency adverbs (always, usually, often, sometimes, never) to form sentences about sports/habits.','Write a short paragraph describing their own sports habits using the target vocabulary and structures.']},
          {slide:5,title:'Aims · Skills',body:['Identify key information about both common and unusual sports (bossaball, curling, karting, snowfering).','Ask and answer questions about sports habits using play / do / go and frequency adverbs.','Write sentences describing personal sports habits.','Use sports-related vocabulary and structures accurately in context.']},
          {slide:6,title:'Aims · Attitudes',body:['Show a positive attitude toward doing sports and keeping healthy.','Demonstrate confidence when using English to talk about themselves and their sports habits.']},
          {slide:7,title:'Coursebooks',body:['Hashemi, L., & Thomas, B. (2010). Objective PET: Student’s Book with Answers (2nd ed.). Cambridge University Press.','Hashemi, L., & Thomas, B. (2010). Objective PET: Workbook with Answers. Cambridge University Press.']},
          {slide:8,title:'References',body:['Harrison, L., Cushen, C. & Hutchison, S. (2014). Practice Test. National Geographic Learning.','Harmer, J. (2000). How to Teach English.','eslgamesworld.com']},
          {slide:9,title:'Warm-up · Guess the Sport',body:['There are 10 pictures of sports hidden behind coloured shapes.','As the shapes slowly disappear, the picture is revealed.','Students try to guess the sport as soon as possible.'],prompt:'Classroom delivery: reveal one clue/picture at a time and ask students to answer in a full sentence.'},
          {slide:10,title:'Warm-up · Video Quiz',body:['Watch the video and choose the correct answers.'],mediaType:'video',mediaKey:'u1-1-slide10-video',mediaCaption:'Video nhúng trong PPT gốc · sẽ phát từ kho media riêng sau khi đăng nhập.',visualNote:'Media được bảo vệ thay vì public trên GitHub.'},
          {slide:11,title:'Unit Transition',body:['Unit 1.1 · A Question of Sport'],visualNote:'Màn chuyển từ Warm-up sang phần Speaking/Introduction.'},
          {slide:12,title:'Speaking · What Sport?',body:['Look at the photos and tell what sport each person is doing.'],prompt:'Ask: “What sport is each person doing?”',answers:['a. cycling','b. horse riding','c. skiing','d. basketball','e. sailing','f. table tennis','g. volleyball','h. tennis','i. gymnastics','j. windsurfing','k. surfing','l. hockey','m. football / soccer','n. rugby','o. athletics'],visualNote:'Ảnh minh hoạ từ PPT sẽ được thay bằng media hợp lệ/ảnh do GV cung cấp trong kho lớp học.'},
          {slide:13,title:'Introduction · Unscramble the Sports',body:['Put the letters in order to make the names of sports. Write the name of the sport by its picture.'],answers:['1. Skiing','2. Cycling','3. Basketball','4. Football','5. Gymnastics','6. Hockey','7. Horse riding','8. Rugby','9. Sailing','10. Surfing','11. Table tennis','12. Tennis','13. Volleyball','14. Windsurfing','15. Athletics']},
          {slide:14,title:'Corpus Spot · do / play / go',body:['I play football.','I go swimming.','I do athletics.','I never do any sport.','I watch lots of sport on television.','I never watch sport.','I sometimes watch sport.'],prompt:'From the examples, work out the rule: play + ? / do + ? / go + ?',answers:['play + a sport with a ball / game','do + a sport showing individual skill / exercise','go + a sport/activity ending in -ing']},
          {slide:15,title:'Classify Sports · play / do / go',body:['football · swimming · tennis · karate · surfing · basketball · athletics · judo · horse riding · cycling · volleyball · badminton · gymnastics · table tennis · skiing · yoga · skating'],prompt:'Put the sports into the correct play / do / go column.',answers:['PLAY: football, tennis, basketball, volleyball, badminton, table tennis','DO: karate, athletics, judo, gymnastics, yoga','GO: swimming, surfing, horse riding, cycling, skiing, skating']},
          {slide:16,title:'Practice · do / play / go',body:['a. She’s really nice and she can ___ volleyball well.','b. In my free time I ___ skiing in winter.','c. We often ___ table tennis in our room.','d. You can ___ horse riding if you want.','e. First we run, then we ___ some gymnastics.'],answers:['a. play','b. go','c. play','d. go','e. do']},
          {slide:17,title:'Language Use · like + -ing',body:['Fill in the blanks with the correct form of like + -ing (play / do / go).','1. I ___ football with my classmates after school because it is fun and keeps me healthy.','2. She ___ gymnastics every weekend since she wants to become more flexible.','3. They ___ swimming in the river when the weather is hot in the summer.','4. My brother ___ basketball on Saturdays because he enjoys playing with his friends.','5. We ___ cycling around the park in the afternoon to relax after doing homework.','6. He ___ karate at the sports centre because he wants to learn self-defence.','7. Anna ___ sailing whenever she travels to the beach with her family.','8. I ___ table tennis in the evening because it is both exciting and good for my eyes.','9. My sister doesn’t ___ rugby because she thinks it is too dangerous.','10. They don’t ___ surfing in the winter because the sea is too cold.'],answers:['1. like playing','2. likes doing','3. like going','4. likes playing','5. like going','6. likes doing','7. likes going','8. like playing','9. like playing','10. like going']},
          {slide:18,title:'Sports Equipment · Match',body:['Work with a partner. Match the equipment to the sports. Some equipment matches more than one sport.'],answers:['basket → basketball','bike → cycling','boat → sailing','net → football / tennis / hockey / volleyball / table tennis','sail → sailing / windsurfing','stick → hockey','bat → table tennis','board → surfing / windsurfing','helmet → cycling / karting','racket → tennis','skis → skiing']},
          {slide:19,title:'Listening 1 · Unusual Sports',body:['Look at the photographs. They show bossaball, curling, snowfering and karting. Guess which sport is in each photograph.'],answers:['a → snowfering','b → bossaball','c → karting','d → curling'],visualNote:'Audio/ảnh gốc sẽ được gọi từ kho học liệu riêng khi bật Classroom Media.'},
          {slide:20,title:'Listening 2 · Identify the Speaker',body:['Listen to four people talking about these sports. Which sport is each person talking about? Write 1, 2, 3 or 4 next to each photo.'],mediaType:'audio',mediaKey:'u1-1-slide20-audio',mediaCaption:'Audio nhúng trong PPT gốc.',answers:['1 → b','2 → a','3 → d','4 → c']},
          {slide:21,title:'Listening 3 · Specific Information',mediaType:'audio',mediaKey:'u1-1-slide21-audio',mediaCaption:'Audio chi tiết nhúng trong PPT gốc.',body:['Bossaball: a) What do they always wear? b) When do they usually play this?','Curling: c) What do they use? d) What do people sometimes say?','Karting: e) How fast can you go indoors? f) What is a kart?','Snowfering: g) Where do they do this? h) What do they use?'],answers:['They always wear shorts.','In the summer.','Special stones and brushes.','It’s a kind of chess (on ice).','Up to 45 kph.','A kind of small racing car.','On the snow (on lakes and fields).','A board and a kind of sail.']},
          {slide:22,title:'Listening 4 · Speaker Attitude',mediaType:'audio',mediaKey:'u1-1-slide22-audio',mediaCaption:'Audio nghe lại nhúng trong PPT gốc.',body:['Listen again. Which words do the speakers use to say how they feel about these sports?'],answers:["It’s fun (in the sun).","It’s exciting (and it’s quite skilful).","It’s not very dangerous.","It’s wonderful."]},
          {slide:23,title:'Language Focus · a kind of',body:['Answer the questions using “It’s a kind of …” and the words in the box.','What’s a helmet?','What’s a racket?','What’s windsurfing?','What’s table tennis?','What’s rugby?','What’s a kart?','What’s snowfering?'],answers:['A helmet → It’s a kind of hat.','A racket → It’s a kind of bat.','Windsurfing → It’s a kind of surfing on water.','Table tennis → It’s a kind of tennis.','Rugby → It’s a kind of team game.','A kart → It’s a kind of car.','Snowfering → It’s a kind of windsurfing on the snow.']},
          {slide:24,title:'Grammar · Adverbs of Frequency',body:['always','usually','often','sometimes','never'],visualNote:'Recreated as a frequency scale for classroom projection: ALWAYS 100% → USUALLY → OFTEN → SOMETIMES → NEVER 0%.'},
          {slide:25,title:'Grammar · Frequency in Context',body:['Use frequency adverbs to describe how often an action happens.','Compare sentences with a main verb and with the verb be.'],visualNote:'Bản web tái tạo bảng ngữ pháp của PPT bằng ví dụ và vị trí trạng từ, tránh phụ thuộc ảnh scan.'},
          {slide:26,title:'Grammar Spot · Word Position',body:['Circle the correct words to complete the rule: Frequency adverbs go before / after a main verb but before / after an auxiliary verb and to be.'],answers:['Rule used in the lesson: before the main verb; after the verb be. In negative forms with do/does not, place the adverb before the main lexical verb.']},
          {slide:27,title:'Practice · Add a Frequency Adverb',body:['Rewrite each sentence using never, sometimes, often, usually or always.','a. Basketball players are tall.','b. Cyclists go very fast.','c. Footballers are very rich.','d. Surfers get wet.','e. Gymnasts wear helmets.','f. There are two people in a tennis match.','g. Good athletes smoke.'],answers:['Basketball players are often tall.','Cyclists usually go very fast.','Footballers are sometimes very rich.','Surfers always get wet.','Gymnasts sometimes wear helmets.','There are always two people in a tennis match.','Good athletes never smoke.']},
          {slide:28,title:'Speaking · Ask and Answer',body:['Work with a partner. Ask and answer using frequency adverbs.','Do you often finish your homework? → Yes, always!','Does your dad sometimes play tennis? → Yes, often.','Are you always tidy? → No, never!','Ideas: make breakfast · play computer games · be polite · wear expensive clothes · remember a friend’s birthday'],prompt:'Pair work: each student asks at least 5 questions and reports one interesting answer.'},
          {slide:29,title:'Corpus Spot · Word Order',body:['Correct the word order mistakes.','a. She comes often to my house.','b. I meet them sometimes in my free time.','c. At weddings people usually are happy and have fun together.','d. I don’t go often to the countryside.','e. He usually doesn’t make jokes.','f. We have a basketball team and we play often against other teams.'],answers:['She often comes to my house.','I sometimes meet them in my free time.','At weddings people are usually happy and have fun together.','I don’t often go to the countryside.','He doesn’t usually make jokes.','We have a basketball team and we often play against other teams.']},
          {slide:30,title:'Personalisation · Complete the Sentences',body:['Complete the sentences about yourself and your family/friends. Use frequency adverbs and use not in some sentences.','a. I don’t often eat cheese for breakfast.','b. My brother usually plays football after class.','c. ___ very tired in the morning.','d. ___ a sleep in the afternoon.','e. ___ in the spring.','f. ___ quiet in English lessons.','g. ___ sport on television.'],prompt:'Students complete with true information, then compare in pairs.'},
          {slide:31,title:'Consolidation',body:['Grammar: Present Simple + frequency adverbs (always, usually, often, sometimes, never).','Listening: specific information about unusual sports (Bossaball, Curling, Karting, Snowfering).','Vocabulary: sports, equipment, and expressions with play / go / do.','Speaking: talking about sports habits using frequency adverbs and play / go / do.','Reading: different kinds of sports and matching pictures, equipment and sport names.','Writing: short sentences about routines and personal sport preferences.']},
          {slide:32,title:'Homework',body:['Write three true sentences using the frequency adverbs with your own ideas.'],prompt:'Submit in the platform: type directly or upload a photo when submission storage is enabled.'},
          {slide:33,title:'Thank You',body:['Any questions?','Unit 1.1 · A Question of Sport'],visualNote:'End-of-lesson screen.'}
        ],
        sections:[
