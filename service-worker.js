const CACHE='e-leap-v0-7';
const CORE=['./','./index.html','./styles.css?v=0.7','./src/app.js?v=0.7','./src/data/catalog.js','./src/data/objectives-b1-unit1.js','./src/services/progress.js'];
